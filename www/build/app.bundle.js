  ...
  .service('workFLowListService',
    ['hmsHttp',
      ...
      function (hmsHttp,
        ...
        // 保存转正信息（转正审批工作流）
        this.savePositiveBlock1 = function (instanceId, trialResult, approveDate, positionId) {
          var url = baseConfig.businessPath + "/wfl_save_action/save_positive_block1_data";
          var response = {"params":{"p_instance_id": instanceId ,"p_trial_result" : trialResult ,"p_approve_date": approveDate
        ...
        // 保存考评结果（转正审批工作流）
        this.savePositiveBlock2 = function (instanceId, record) {
          var deferred = $q.defer();
          var Url =baseConfig.businessPath  + "/get_workflow_data/save_positive_block2_data";
          var PostData = '{"params":{"p_instance_id":"' + instanceId + '","p_record":{"record":' + record + '}}}';
        ...
        // 保存试用期总结（转正审批工作流）
        this.savePositiveBlock3 = function (instanceId, fieldId, fieldValue) {
          var deferred = $q.defer();
          var url = baseConfig.businessPath +  "/wfl_save_action/save_positive_block3_data";
          var PostData = '{"params":{"p_instance_id":"' + instanceId + '","p_field_id":"' + fieldId + '","p_field_value":"' + fieldValue + '"}}';
