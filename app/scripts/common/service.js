  ...
  service('publicMethod', ['$filter', '$ionicLoading', '$ionicPopup', '$ionicHistory',
    function ($filter, $ionicLoading, $ionicPopup, $ionicHistory) {
      return {
        ...
        showPopup2: function (template) {
          $ionicPopup.show({
            template: '<img style="height:80px;float: left;position: absolute;top: -40px;left: 85px;" ' +
            'src="build/img/application/information/icon_miss_signup@3x.png">'+template,
            buttons: [
              {
                text: '确定',
                type: 'button button-cux-popup-confirm'
