...
//判断数组中是否含有某个元素
function inArrayId(array, contactId) {
  for (var i = 0; i < array.length; i++) {
...
function inArrayCompetitorId(array,competitorId){
  for (var i = 0; i < array.length; i++) {
    if (array[i].competitorId === competitorId)
      return true;
  }
  return false;
}
//判断数组中是否含有某个元素
function inArrayVaule(array, value) {
  for (var i = 0; i < array.length; i++) {
...
function inArrayOfferHeaderId(array,value){
  for (var i = 0; i < array.length; i++) {
    if (array[i].offerHeaderId === value)
      return true;
  }
  return false;
}
