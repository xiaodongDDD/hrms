...
angular.module('bidbondModule')
  .controller('addbidbondCtrl', [
    ...
    function ($scope,
      ...
      //      var tempbidbond = opportunityDetailDataService.getOpportunity();
      //      $scope.nameBeforeEdit = tempbidbond.opportunityName;
      //
      //      $scope.data = {
      //        businessFrom: tempbidbond.businessFrom,//商机来源,判断原厂划分
      //        customerId: tempbidbond.customerId,    //客户Id，判断客户联系人
      //        description: tempbidbond.description,  //商机描述
      //        fullName: tempbidbond.opportunityName, //商机名称
      //        opportunityCode: tempbidbond.opportunityCode, //必传
      //        opportunityId: tempbidbond.opportunityId,     //必传
      //        preMoney: tempbidbond.preMoney,        //预计收入
      //        preSignDate: tempbidbond.preSignDate,  //项目签署日期
      //        prjBeginDate: tempbidbond.prjBeginDate,//项目开始日期
      //        opportunityStatus: tempbidbond.opportunityStatus, //商机状态，判断rate
      //        prjRisk: tempbidbond.prjRisk           //项目风险
      //      };
      //
      //      $scope.showData = {
      //        preSaleEmployee: tempbidbond.preSaleEmployeeName,
      //        newEstimateUnitName: "",
      //        companyId: tempbidbond.companyIdName,
      //        businessFrom: tempbidbond.businessFromName,
      //        opportunityStatus: tempbidbond.opportunityStatusName,
      //        industry: tempbidbond.industryName,
      //        saleStage: tempbidbond.saleStageName,
      //        chargingMode: tempbidbond.chargingModeName,
      //        currency: tempbidbond.currencyName,
      //        expectPaymentType:tempbidbond.expectPaymentType,
      //        saleArea: tempbidbond.saleAreaName,
      //        saleTeam: tempbidbond.saleTeamName,
      //        customerName: tempbidbond.customerName,
      //        customerContactsName: tempbidbond.customersContactsName,
      //        saleBelong: tempbidbond.saleAreaName + ' | ' + tempbidbond.saleTeamName,
      //        originalFactoryFrom: tempbidbond.originalFactoryFromName
      //      };
      //      $scope.showData.customerContactsName = tempbidbond.customersContactsName;
      //
      //
      //      addbidbondService.getOpportunityStatus(getStatusForRateSuccess);
      //
      //    });
      //
