...
public class LunarCalendar {
	...
	final static String[] solarHoliday = new String[] { //
			"0101 元旦", "0214 情人", "0308 妇女", "0312 植树", "0401 愚人","0404 清明", "0501 劳动",  //
			 "0601 儿童", "0801 建军", "0910 教师",//
			 "1001 国庆",   "1225 圣诞" };

    // 工作日
    final static String[] workingDays = new String[]{"0206","0214","0612","0918","1008","1009"};
	// 休息日
	final static String[] relaxDays = new String[]{"0101","0102","0103"  //元旦
			                                      ,"0207","0208","0209","0210","0211","0212","0213" //春节
			                                      ,"0402","0403","0404" //清明
			                                      ,"0430","0501","0502"//劳动节
			                                      ,"0609","0610","0611" //端午节
                                                  ,"0915","0916","0917" //中秋节
	...
	//判断是调休日还是节假日
    public  String getDayType(int year_log, int month_log, int day_log){
		for(int i=0;i<workingDays.length;i++) {
			String worksd = workingDays[i];
			String smonth_v = month_log + "";
			String sday_v = day_log + "";
			String smd = "";
			if (month_log < 10) {
			...
			smd = smonth_v + sday_v;
			if (worksd.trim().equals(smd.trim())) {
				return "work";
			}
		  }

		for(int i=0;i<relaxDays.length;i++) {
			String relaxsd = relaxDays[i];
			String smonth_v = month_log + "";
			String sday_v = day_log + "";
			String smd = "";
			if (month_log < 10) {
			...
			smd = smonth_v + sday_v;
			if (relaxsd.trim().equals(smd.trim())) {
				return "relax";
			}
		}
			return "none";
