...
//    select = selectdate;//选择的日期
    ...
    NSInteger months = (afterYear-todayYear) * monthNum + (afterMonth - todayMonth);
    ...
    for (int i = months; i >0; i--) {
        ...
        NSDate *month = [today dayInTheBeforeMonth:i];
        ...
        [calendarMonth insertObject:calendarDays atIndex:(months-i)];
    }
...
- (NSMutableArray *)calculateDaysInPreviousMonthWithDate:(NSDate *)date andArray:(NSMutableArray *)array {
    ...
    for (int i = daysCount - partialDaysCount + 1; i < daysCount + 1; ++i) {
        ...
        calendarDay.WorkOrRest = CellDayOther;
...
- (void)calculateDaysInCurrentMonthWithDate:(NSDate *)date andArray:(NSMutableArray *)array {
    ...
    for (int i = 1; i < daysCount + 1; ++i) {
        ...
        NSDate *currentDate = [calendarDay date];
        calendarDay.week = [currentDate getWeekIntValueWithDate];
        calendarDay.weekIndex = [currentDate numberOfWeeksIndex];
...
- (void)changStyle:(CalendarDayModel *)calendarDay {
    ...
    calendarDay.WorkOrRest = CellDayOther;
    //2016的节假日
    if (calendarDay.year==2016) {
        switch (calendarDay.month) {
            case 1:
                if (calendarDay.day>=1&&calendarDay.day<=3) {
                    calendarDay.WorkOrRest = 1;
                }else if (calendarDay.day==4){
                    calendarDay.WorkOrRest = 0;
                }else{
                    calendarDay.WorkOrRest = 2;
                }
                break;
            case 2:
                if (calendarDay.day>=7&&calendarDay.day<=13) {
                    calendarDay.WorkOrRest = 1;
                }else if (calendarDay.day==6||calendarDay.day==14){
                    calendarDay.WorkOrRest = 0;
                }else{
                    calendarDay.WorkOrRest = 2;
                }
                break;
            case 4:
                if (calendarDay.day>=3&&calendarDay.day<=5) {
                    calendarDay.WorkOrRest = 1;
                }else if (calendarDay.day==2||calendarDay.day==6) {
                    calendarDay.WorkOrRest = 0;
                }else{
                    calendarDay.WorkOrRest = 2;
                }
            ...
            case 5:
                ...
                break;
            case 6:
                if (calendarDay.day>=9&&calendarDay.day<=11) {
                    calendarDay.WorkOrRest = 1;
                }else if (calendarDay.day==12){
                    calendarDay.WorkOrRest = 0;
                }else{
                    calendarDay.WorkOrRest = 2;
                }
                break;
            case 9:
                if (calendarDay.day>=15&&calendarDay.day<=17) {
                    calendarDay.WorkOrRest = 1;
                }else if (calendarDay.day==18){
                    calendarDay.WorkOrRest = 0;
                }else{
                    calendarDay.WorkOrRest = 2;
                }
                break;
            case 10:
                if (calendarDay.day>=1&&calendarDay.day<=7) {
                    calendarDay.WorkOrRest = 1;
                }else if (calendarDay.day==8||calendarDay.day==9){
                    calendarDay.WorkOrRest = 0;
                }else{
                    calendarDay.WorkOrRest = 2;
                }
...
//        }
        ...
        calendarDay.holiday = @"光棍节";
             ...
             calendarDay.weekIndex == 2 &&
             calendarDay.week == 7
             ) {
        calendarDay.holiday = @"母亲节";
        
    } //6月第三个星期日父亲节
    else if (calendarDay.month == 6 &&
             calendarDay.weekIndex == 3 &&
             calendarDay.week == 1
             ) {
        calendarDay.holiday = @"父亲节";
