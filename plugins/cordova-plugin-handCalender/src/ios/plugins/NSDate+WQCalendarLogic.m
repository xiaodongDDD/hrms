...
- (NSUInteger)numberOfWeeksInCurrentMonth
{
    ...
    NSUInteger weekday = [firstDate weeklyOrdinality];
...
//获取当天是第几周
- (NSUInteger)numberOfWeeksIndex
{
    NSDate* firstDate=[self firstDayOfCurrentMonth] ;
    NSUInteger weekday = [firstDate weeklyOrdinality];
   
    NSUInteger days = [self getDayNumbertoDayIn:firstDate beforDay:self];
    NSUInteger weeks = 0;
...
//获取当前日期之前的几个月
- (NSDate *)dayInTheBeforeMonth:(int)month
{
    NSDateComponents *dateComponents = [[NSDateComponents alloc] init];
