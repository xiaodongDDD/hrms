...
- (void)goTargetCell {
    NSIndexPath *indexPath = [NSIndexPath indexPathForItem:0 inSection:monthNum];
    ...
    if (count == 0) {
       ...
       // NSMutableArray *Array = [NSMutableArray array];
        ...
        if (beginDay.day>endDay.day) {
            [selectcalendarList removeObjectAtIndex:0];
            [selectcalendarList addObject:first];
            beginDay = selectcalendarList.firstObject;
            endDay = selectcalendarList.lastObject;
        }
