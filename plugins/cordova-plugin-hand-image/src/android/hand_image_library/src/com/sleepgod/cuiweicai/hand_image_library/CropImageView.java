...
/**
 * Created by cuiweicai on 16/10/12.
 */
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mStatus == STATUS_MULTI_TOUCHING) {
                    ...
                    Log.d("CropImageView", "onTouchEvent: dx"+dx +"  dy"+dy);
                    // 根據得到的那一个角，并且变换Rect
                    if (!(dx == 0 && dy == 0)) {
                        switch (currentEdge) {
                            case EDGE_LT:
...
//                                        mDrawableFloat.bottom);
                                mind=   getleast(mDrawableFloat.left + dx,mDrawableFloat.top + dy,mDrawableFloat.right,mDrawableFloat.bottom);

                                mDrawableFloat.set(mDrawableFloat.right-mind,
                                        mDrawableFloat.bottom-mind, mDrawableFloat.right,
                                        mDrawableFloat.bottom);
                                break;
...
//                                                + dx, mDrawableFloat.bottom);
                                mind=   getleast(mDrawableFloat.left,
                                        mDrawableFloat.top + dy, mDrawableFloat.right
                                                + dx, mDrawableFloat.bottom);

                                mDrawableFloat.set(mDrawableFloat.left,
                                        mDrawableFloat.bottom-mind, mDrawableFloat.left+mind, mDrawableFloat.bottom);
                                break;
...
//                                        mDrawableFloat.bottom + dy);
                                ...
                                mind=   getleast(mDrawableFloat.left + dx,
                                        mDrawableFloat.top, mDrawableFloat.right,
                                        mDrawableFloat.bottom + dy);

                                mDrawableFloat.set(mDrawableFloat.right-mind,
                                        mDrawableFloat.top, mDrawableFloat.right,
                                        mDrawableFloat.top+mind);
                                break;
...
//                                        mDrawableFloat.bottom + dy);
                                ...
                                mDrawableFloat.set(mDrawableFloat.left,
                                        mDrawableFloat.top, mDrawableFloat.left+mind,
                                        mDrawableFloat.top+mind);
                                break;
    ...
    protected void checkBounds() {
        ...
        Log.d("crop","newLeft: "+newLeft);
        Log.d("crop","newTop: "+newTop);
        Log.d("crop","getTop(): "+getTop());
        Log.d("crop","getLeft(): "+getLeft());
        ...
        //相对坐标系不一样mFloatDrawable 相对于mDrawable ,mDrawable相对于窗口
        if (mDrawableFloat.top < getTop()-getTop()) {
            newTop = getTop()-getTop();
            isChange = true;
        }
        ...
        if (mDrawableFloat.bottom > getBottom()-getTop()) {
            newTop = getBottom() - mDrawableFloat.height() -getTop();//getTop 是减去相对坐标系值
            isChange = true;
        }
    ...
    private int getleast(int left, int top, int right, int bottom) {
        int d;
        d =bottom-top >right-left ? right-left:bottom-top;
        return d;
    }
