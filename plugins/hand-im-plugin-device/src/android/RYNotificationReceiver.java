...
import com.hand.china.hrms2.research.MainActivity;
...
public class RYNotificationReceiver extends PushMessageReceiver {
    ...
    public boolean onNotificationMessageArrived(Context context, PushNotificationMessage pushNotificationMessage) {
        ...
        mBuilder.setContentTitle("消息提醒")//设置通知栏标题
                ...
                .setAutoCancel(true)
                .setSmallIcon(Util.getRS("header", "drawable", context.getApplicationContext()));//设置通知小ICON
