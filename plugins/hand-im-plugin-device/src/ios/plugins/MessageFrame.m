...
-(void)setMessage:(RCMessage *)message
{
    ...
    if (message.messageDirection==MessageDirection_RECEIVE) {
        ...
        if ([message.content  isKindOfClass:[RCTextMessage class]]) {
            ...
            //图片消息
            self.messageLabelSize = CGRectMake(CGRectGetMaxX(self.iconSize)+iconRightSpace, self.iconSize.origin.y+2, imageMessageSize.width, imageMessageSize.height);
        ...
        if ([message.content  isKindOfClass:[RCTextMessage class]]) {
            ...
            //图片消息
            self.messageLabelSize = CGRectMake(CGRectGetMinX(self.iconSize)-iconRightSpace-imageMessageSize.width, self.iconSize.origin.y+2, imageMessageSize.width, imageMessageSize.height);//imageMessageBoder*2.0
    ...
    self.heightForCell = CGRectGetMaxY(self.messageLabelSize) + 2*standardSpaceY ;
