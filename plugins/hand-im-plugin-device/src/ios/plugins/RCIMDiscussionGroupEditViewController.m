...
- (void)viewDidLoad {
    ...
    titleView.attributedText = [[NSAttributedString alloc] initWithString:@"创建讨论组" attributes:@{NSForegroundColorAttributeName:[UIColor whiteColor],NSFontAttributeName:[UIFont systemFontOfSize:17]}];
...
- (void)finishedCreate
{
    ...
    if (self.textField.text.length==0) {
      ...
      //  [self insertNewContact:self.memberList];
        ...
        //创建讨论组
        [[RCIMClient sharedRCIMClient] createDiscussion:self.textField.text userIdList:self.memberList success:^(RCDiscussion *discussion) {
