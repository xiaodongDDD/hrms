...
- (void)isOpenNewMessageNotification:(UISwitch *)sender
{
    ...
    [[RCIMClient sharedRCIMClient] setConversationNotificationStatus:ConversationType_DISCUSSION targetId:self.discussionId isBlocked:YES success:^(RCConversationNotificationStatus nStatus) {
