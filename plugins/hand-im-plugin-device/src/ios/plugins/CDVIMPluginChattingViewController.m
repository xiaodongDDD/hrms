...
- (void)viewDidLoad
{
  ...
  //  [self setMessagePortraitSize:CGSizeMake(64, 64)];
    ...
    self.navigationItem.title = [NSString stringWithFormat:@"%@（来自TECH部门）",_navTitle];
    //[self.navigationController.navigationBar setTintColor:[UIColor colorWithHexString:@"#24559C" alpha:1.0]];
    //[self.navigationController.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor colorWithHexString:@"#4A4A4A" alpha:1.0],NSFontAttributeName:[UIFont systemFontOfSize:17]}];
      self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"返回" style:UIBarButtonItemStylePlain target:self action:@selector(dissmiss)];

    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageWithCGImage:[UIImage imageNamed:@"dial_2x"].CGImage scale:1.6 orientation:UIImageOrientationUp] style:UIBarButtonItemStyleDone target:self action:@selector(call:)];
}
...
-(void)loginRongCloud
{
    ...
    //10100 @"C7+levlHNn9XrnnWTT03lllLUTMDagqb7z8dTqJKoTt0JHVAabLVUZtmcL6qLCybMykHDWWmEaGgVxHEv3ZAXg=="
    //10101 "Z0UlKIjcWqYbOshfngwNC1lLUTMDagqb7z8dTqJKoTt0JHVAabLVUf/TjGkBDUrTmen/J3gPG+6UiAfZePpL3A=="
    NSString *token = @"Z0UlKIjcWqYbOshfngwNC1lLUTMDagqb7z8dTqJKoTt0JHVAabLVUf/TjGkBDUrTmen/J3gPG+6UiAfZePpL3A==";
