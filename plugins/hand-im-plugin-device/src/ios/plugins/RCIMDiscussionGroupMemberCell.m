...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.memberName = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.memberImageV.frame), self.bounds.size.width, 18)];
        [self.memberName setTextAlignment:NSTextAlignmentCenter];
        [self.memberName setFont:[UIFont systemFontOfSize:16.0]];
